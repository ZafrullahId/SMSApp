...
namespace Persistence.Mail
{
    public class MailService : IMailService
    {
        ...
        public void SendEMailAsync(MailRequest mailRequest)
        {
            ...
            string SenderName = "Success Extrammural Classes";
            ...
            string ReplyToName = "Success Extrammural Classes";
            ...
            JObject Params = new JObject
            {
                ...
                { "subject", "Success Extrammural Classes" }
            };
